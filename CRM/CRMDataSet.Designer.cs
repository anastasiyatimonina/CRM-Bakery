...
namespace CRM.CRMDataSetTableAdapters {
    ...
    public partial class AccountTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Account] WHERE (([UserId] = @Original_UserId) AND ([Login] = @" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Account] ([Login], [Password]) VALUES (@Login, @Password);\r\nSE" +
                "LECT UserId, Login, Password FROM Account WHERE (UserId = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Account] SET [Login] = @Login, [Password] = @Password WHERE (([User" +
                "Id] = @Original_UserId) AND ([Login] = @Original_Login) AND ([Password] = @Origi" +
                "nal_Password));\r\nSELECT UserId, Login, Password FROM Account WHERE (UserId = @Us" +
                "erId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT UserId, Login, Password FROM dbo.Account";
        ...
        public virtual int Fill(CRMDataSet.AccountDataTable dataTable) {
        ...
        public virtual CRMDataSet.AccountDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CRMDataSet.AccountDataTable dataTable = new CRMDataSet.AccountDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CRMDataSet.AccountDataTable dataTable) {
        ...
        public virtual int Update(string Login, string Password, int Original_UserId, string Original_Login, string Original_Password, int UserId) {
            if ((Login == null)) {
                throw new global::System.ArgumentNullException("Login");
            }
            else {
        ...
        public virtual int Update(string Login, string Password, int Original_UserId, string Original_Login, string Original_Password) {
            return this.Update(Login, Password, Original_UserId, Original_Login, Original_Password, Original_UserId);
        }
    }
